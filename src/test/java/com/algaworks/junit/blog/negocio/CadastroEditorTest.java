...
class CadastroEditorTest {
    ...
    ArmazenamenteoEditorFixoEmMemoria armazenamentoEditor;
    Editor editor;

    @BeforeAll
    static void beforeAll() {
        cadastroEditor = new CadastroEditor(
                new ArmazenamenteoEditorFixoEmMemoria(),
    ...
    @BeforeEach
    void beforeEach() {
        editor = new Editor(null, "Alex", "jota@gmai.com", BigDecimal.TEN, true);
    }
